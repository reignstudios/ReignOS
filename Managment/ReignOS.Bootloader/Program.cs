...
internal class Program
{
    ...
    private static void StartCompositor_Gamescope()
    {
        ...
        ProcessUtil.Run($"{gpuArg}gamescope", $"--display-index=1 -e -f{useMangoHubArg}{vrrArg}{hdrArg}{rotArg}{displayRezArg} -- ./Start_Gamescope.sh{steamGPUArg}{steamDeckArg}", useBash:true, verboseLog:true);// --framerate-limit
    }
