...
internal class Program
{
    ...
    private static void StartCompositor_Gamescope()
    {
        ...
        string result = ProcessUtil.Run("gamescope", "-e -f --adaptive-sync --hdr-enabled --framerate-limit 60 -- ./Start_Gamescope.sh", out _, enviromentVars:null, wait:true);// start Gamescope with Steam in console mode, VRR
        Log.WriteLine(result);
    }
}