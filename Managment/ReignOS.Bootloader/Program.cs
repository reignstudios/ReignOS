...
internal class Program
{
    ...
    private static void StartCompositor_Gamescope(bool useMangoHub)
    {
        ...
        string result = ProcessUtil.Run("MANGOHUD=1 gamescope", $"-e -f --adaptive-sync --hdr-enabled --framerate-limit -- ./Start_Gamescope.sh{useMangoHubArg}", useBash:false);// start Gamescope with Steam in console mode, VRR
