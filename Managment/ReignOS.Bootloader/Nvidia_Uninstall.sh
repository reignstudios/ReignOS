...
sudo pacman -R --noconfirm nvidia-340xx
sudo pacman -R --noconfirm nvidia-340xx-utils
sudo pacman -R --noconfirm lib32-nvidia-340xx-utils
sudo pacman -R --noconfirm nvidia-340xx-settings

echo "Uninstalling Nvidia Proprietary drivers"
sudo pacman -R --noconfirm nvidia-470xx nvidia-470xx-utils lib32-nvidia-470xx-utils nvidia-470xx-settings
sudo pacman -R --noconfirm nvidia-470xx
sudo pacman -R --noconfirm nvidia-470xx-utils
sudo pacman -R --noconfirm lib32-nvidia-470xx-utils
sudo pacman -R --noconfirm nvidia-470xx-settings

echo "Uninstalling Nvidia Proprietary drivers"
sudo pacman -R --noconfirm nvidia-580xx nvidia-580xx-utils lib32-nvidia-580xx-utils nvidia-580xx-settings
sudo pacman -R --noconfirm nvidia-580xx
sudo pacman -R --noconfirm nvidia-580xx-utils
sudo pacman -R --noconfirm lib32-nvidia-580xx-utils
sudo pacman -R --noconfirm nvidia-580xx-settings
